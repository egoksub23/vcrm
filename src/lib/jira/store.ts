...
export const TICKET_COLUMNS =
  "id, account_id, ticket_number, contact_id, subject, description, category, status, priority, assigned_agent_id, created_by";
...
export interface JobRow {
  ...
  kind: "sync_issue" | "push_status" | "post_comment" | "edit_comment";
